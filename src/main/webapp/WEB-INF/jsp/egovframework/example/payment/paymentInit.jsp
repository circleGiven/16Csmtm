	...
	<div class="row clearfix mb">
		<div class="breadcrumbIn">
			<ul>
				...
				<li><a href="paymentInit.do"> 결제 </a></li>
			</ul>
		</div><!-- breadcrumb -->
	</div><!-- row -->
					    		...
					    		<div class="payment-card__front">
								    <div class="payment-card__group">
								        <label class="payment-card__field">
								        	<span class="payment-card__hint">카드 소유자</span>
								        	<input class="payment-card__input" placeholder="Holder of card" pattern="[A-Za-z, ]{2,}" name="holder-card" required>
								        </label>
								    </div>
					      			<div class="payment-card__group">
								        <label class="payment-card__field">
									        <span class="payment-card__hint">카드 번호</span>
									        <input type="text" class="payment-card__input" style="height: 40px;" placeholder="Number of card" pattern="[0-9]{16}" name="number-card" required>
								        </label>
					      			</div>
					      			<div class="payment-card__group">
					      			...
					      			<div class="payment-card__group payment-card__footer">
								        <label class="payment-card__field payment-card__month">
								          	...
								          	<input type="text" class="payment-card__input" style="height: 30px;" placeholder="MM" maxlength="2" pattern="[0-9]{2}" name="mm-card" required>
								        </label>
					        			<span class="payment-card__separator">/</span>
					       				<label class="payment-card__field payment-card__year">
					          				...
					          				<input type="text" class="payment-card__input"style="height: 30px;" placeholder="YY" maxlength="2" pattern="[0-9]{2}" name="year-card" required>
					        			</label>
									</div>
								</div>
									...
									<div class="payment-card__group">
										<label class="payment-card__field payment-card__cvc">
											<span class="payment-card__hint">CVC</span>
					          				<input type="text" class="payment-card__input" style="height: 30px;" placeholder="CVC" maxlength="3" pattern="[0-9]{3}" name="cvc-card" required>
					        			</label>
					      			</div>
					    		</div>
					    	</div>
